...
# Meta and Title
$content = $content -replace '<title>Mahindra Vista Kandivali East \| Premium 2, 3 & 4 BHK Apartments</title>', '<title>New Phase Launch at Rustomjee Ozone Goregaon West</title>'
$content = $content -replace 'content="Mahindra Vista Kandivali East is a premium residential project located in the heart of Mumbai. Designed to offer modern living, it combines stylish architecture with green surroundings."', 'content="New Phase Launch at Rustomjee Ozone Goregaon West. Premium 2 & 3 BHK Apartments in Goregaon West New Launch. Exclusive Pre-Launch Opportunity at Rustomjee Ozone."'
$content = $content -replace 'content="Mahindra Vista, Kandivali East, Premium apartments, 2 BHK Kandivali, 3 BHK Kandivali, 4 BHK Kandivali, Mahindra Lifespaces, Luxury homes Mumbai, Eco-friendly community"', 'content="Rustomjee Ozone new phase, Goregaon West new tower launch, Pre-launch benefits Rustomjee Ozone, G+49 luxury tower Goregaon West, 2 BHK 3 BHK flat SV Road, NeoLiv Goregaon West project"'
$content = $content -replace '<meta name="author" content="Mahindra Group">', '<meta name="author" content="NeoLiv Group">'

# Nav Logo
$content = $content -replace 'alt="Mahindra Vista"', 'alt="Rustomjee Ozone"'

# Hero Section
$content = $content -replace 'Mahindra\s*Vista, <br>  <p class="text-sm text-gray-700 text-center mb-4 font-semibold uppercase tracking-wider">\s*At Kandivali East   </p>', 'Rustomjee Ozone, <br>  <p class="text-sm text-gray-700 text-center mb-4 font-semibold uppercase tracking-wider">At SV Road, Mahesh Nagar, Goregaon West</p>'
$content = $content -replace 'By Mahindra LifeSpaces', 'New Tower By NeoLiv Group & Trusted Construction Partners'

# Hero Info Boxes
$content = $content -replace '<p class="text-sm text-gray-500 uppercase tracking-wider">Land Parcel</p>\s*<p class="font-bold text-gray-800">3.53 Acres</p>', '<p class="text-sm text-gray-500 uppercase tracking-wider">Configuration</p><p class="font-bold text-gray-800">2 & 3 BHK</p>'
$content = $content -replace '<p class="text-xs text-gray-600 text-center">Towers</p>\s*<p class="text-center text-black font-bold">5 Towers</p>', '<p class="text-xs text-gray-600 text-center">Elevation</p><p class="text-center text-black font-bold">G+49 Storeys</p>'
$content = $content -replace '<p class="text-sm text-gray-500 uppercase tracking-wider">Possession</p>\s*<p class="text-sm font-bold text-gray-800">December 2028 \*</p>', '<p class="text-sm text-gray-500 uppercase tracking-wider">RERA No</p><p class="text-sm font-bold text-gray-800">Coming Soon</p>'

# CTA text
$content = $content -replace '<p> Avail early bird benefits</p>\s*<p> Get Choice of Inventory</p>\s*<p> Avail spot booking offers & Best Price</p>', '<p> Get Pre-Launch Benefits</p><p> Avail Early Bird Offer</p><p> Spot Booking Offers Available & Best Price Guaranteed</p>'

# Hero Price
$content = $content -replace 'Lavish 2, 3 & 4 BHK residences <br>\s*<span class="text-base font-medium text-gray-700">Starting From <br> <strong\s*style="font-size: 22px">₹ 1.86 Cr All Inclusive</strong></span>', 'Premium 2 & 3 BHK Apartments <br><span class="text-base font-medium text-gray-700">Starting From <br> <strong style="font-size: 22px">₹ 2.50 Cr All Inclusive</strong></span>'

# Highlights Intro
$content = $content -replace '<h2 class="font-heading text-4xl md:text-5xl font-bold text-navy mb-4">Mahindra Vista Kandivali Highlights</h2>', '<h2 class="font-heading text-4xl md:text-5xl font-bold text-navy mb-4">Rustomjee Ozone Goregaon Highlights</h2>'
$content = $content -replace '<p class="text-xl text-gray-600 max-w-2xl mx-auto font-body">Exceptional features that define luxury living in Kandivali East. 50\+ Modern Amenities.</p>', '<p class="text-xl text-gray-600 max-w-2xl mx-auto font-body">Premium high-rise living with rooftop amenities on SV Road. Best gated community high-rise under pre-launch pricing in Goregaon West.</p>'

# Highlights Cards
$old_cards = [regex]::Escape(@'
...
$content = $content -replace 'Mahindra Vista Kandivali East - Pricing Plans', 'Rustomjee Ozone Goregaon - Pricing Plans'

$old_pricing = [regex]::Escape(@'
                <!-- Pricing Cards -->
...
# Floor plans
$content = $content -replace 'Mahindra Vista Kandivali East Master & Floor Plans', 'Rustomjee Ozone Master & Floor Plans'

# Amenities
$content = $content -replace 'Mahindra Vista Kandivali East\s*-\s*Amenities', 'Rustomjee Ozone Goregaon - Amenities'

# Gallery
$content = $content -replace 'Mahindra Vista Kandivali East\s*-\s*<span class="text-gold">Gallery</span>', 'Rustomjee Ozone - <span class="text-gold">Gallery</span>'

# Location
$content = $content -replace 'Located in the heart of Kandivali East, offering seamless access to Mumbai''s primary hubs.', 'Located in the heart of Goregaon West, offering seamless access to Mumbai''s primary hubs.'

$old_location_cards = [regex]::Escape(@'
...
$content = $content -replace 'https://www.google.com/maps/embed\?pb=!1m18!1m12!1m3!1d3768.182470701146!2d72.868744!3d19.201234!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b738e4a7b7a1%3A0x8f8c8c8c8c8c8c8c!2sMahindra%20Lifespaces%20Vista!5e0!3m2!1sen!2sin!4v1715473561085!5m2!1sen!2sin', 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15082.903823483984!2d72.83617651738281!3d19.1634591!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b65389656cd9%3A0x6e9a65d5029bcda!2sRustomjee%20Ozone!5e0!3m2!1sen!2sin!4v1716388480392!5m2!1sen!2sin'

# About builder
$old_builder = [regex]::Escape(@'
                    <h2 class="font-heading text-3xl md:text-4xl font-bold text-[#C9211A] mb-8">About Mahindra Group
                    </h2>
...
$new_builder = @'
                    <h2 class="font-heading text-3xl md:text-4xl font-bold text-[#C9211A] mb-8">About NeoLiv Group
                    </h2>
                    <div class="w-24 h-1 bg-secondary mx-auto mb-8"></div>
                    <p class="text-lg text-gray-600 leading-relaxed mb-8 font-body">
...
# Footer
$content = $content -replace 'Mahindra Vista Kandivali East is a premium residential project by Mahindra Lifespaces,\s*offering luxurious 2, 3 & 4 BHK residences with a blend of luxury and nature.', 'Rustomjee Ozone Goregaon West is a premium high-rise G+49 tower by NeoLiv Group, offering highly efficient 2 & 3 BHK premium residences at SV Road.'
$content = $content -replace '<strong>Possession:</strong> December 2028 \*', '<strong>RERA No:</strong> Coming Soon'
$content = $content -replace '© 2025 Mahindra Vista Kandivali East. All rights reserved.', '© 2026 Rustomjee Ozone (New Phase). All rights reserved.'
$content = $content -replace 'MAHA RERA Project Registration No.: P51800054671', 'MAHA RERA Project Registration No.: Coming Soon'
$content = $content -replace '<span>Off Western Express Highway, Akurli Road, Kandivali East</span>', '<span>SV Road, Mahesh Nagar, Goregaon West, Mumbai</span>'
